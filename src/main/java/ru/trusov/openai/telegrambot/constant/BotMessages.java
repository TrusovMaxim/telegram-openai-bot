...
public interface BotMessages {
    ...
    String MESSAGE_INFO = """
            ...
            """;
    String MESSAGE_SUPPORT = """
            Данный бот создан энтузиастом в свободное время. В настоящий момент поддержку осуществляю я сам.
            
            Если возникли проблемы, пожалуйста, напишите мне с подробностями — буду рад помочь!
