...
> 📂 Теперь проект доступен как **открытый исходный код** на [GitHub](https://github.com/TrusovMaxim/telegram-openai-bot).  
> 🚀 Развернуть можно без программирования — создайте своего бота в Telegram и введите ключи.  
> ⭐️ Если проект вам понравился, поставьте звезду на [GitHub](https://github.com/TrusovMaxim/telegram-openai-bot) — это лучшая поддержка!
